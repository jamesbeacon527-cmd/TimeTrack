            ...
            <div className="fixed bottom-4 left-1/2 -translate-x-1/2 w-[calc(100%-1.5rem)] max-w-[380px] z-[100] sm:relative sm:translate-x-0 sm:w-auto sm:max-w-none sm:bottom-auto sm:left-auto sm:right-auto sm:z-auto flex bg-carbon/95 sm:bg-carbon backdrop-blur-xl sm:backdrop-blur-none border border-border sm:border shadow-2xl sm:shadow-none rounded-[24px] sm:rounded-lg p-1 gap-1 overflow-x-auto no-scrollbar">
              {[
                ...
                <button
                  ...
                  className={`flex flex-col sm:flex-row items-center justify-center gap-0.5 sm:gap-1.5 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-[20px] sm:rounded-md text-[9px] sm:text-[10px] md:text-xs font-semibold uppercase tracking-widest transition-all flex-1 min-w-[50px] sm:min-w-[70px] md:min-w-[100px] ${
        ...
        <main className="flex-1 min-h-0 w-full min-w-0 max-w-full flex flex-col">
          {view === "home" ? (
            ...
            <>
              ...
              <div className="lg:hidden flex flex-col space-y-12 w-full min-w-0">
                {view === "capture" && (
                  <>
                    <div className="space-y-4 w-full min-w-0">
                      ...
                      <div className="bg-carbon/40 rounded-3xl p-4 sm:p-6 border border-border shadow-xl relative overflow-hidden w-full min-w-0">
